...
//         {/* Breadcrumb */}
//         <div className="mb-8">
//           <Link to="/blog" className="flex items-center text-gold-600 hover:text-gold-700 mb-4 transition-colors">
...
//               <div className="bg-gold-500 text-white text-sm font-bold px-2 py-1 rounded mb-3 inline-block">
//                 {blog.category}
//               </div>
