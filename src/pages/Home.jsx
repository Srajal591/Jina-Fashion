      ...
      <section className="bg-[#8D493A] text-white py-4">
        <div className="text-center">
          <p className="text-lg font-medium">
            🎉 Special Offer: Get 25% off on all jewelry items | Free shipping
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-[#8D493A] max-w-2xl mx-auto">
              Handpicked pieces that showcase exceptional craftsmanship and
              timeless elegance
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                name: "Necklaces",
                image:
                  "https://2.bp.blogspot.com/-Avz08GINVSY/UCu9W226RRI/AAAAAAAACiA/qnUhz1aeD8M/s1600/necklace-zoom-DSC_9776.jpg",
                category: "necklaces",
              },
              {
                name: "Bracelets",
                image:
                  "https://cdn.shopify.com/s/files/1/2988/2568/products/0E8A0097_9866aaf3-22cf-42ed-95a8-ad7983e9aaac_2048x2048.jpg?v=1579560027",
                category: "bracelets",
              },
            ].map((cat) => (
