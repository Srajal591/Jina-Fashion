              ...
              {[
                {
                  ...
                  content:
                    "123 Jewelry Street, Fashion District\nMumbai, Maharashtra 400001\nIndia",
                },
                {
                ...
                <div
                  key={idx}
                  className="bg-[#DFD3C3] p-6 rounded-lg shadow-sm"
                >
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-[#8D493A]">
                        {item.title}
                      </h3>
                      <p className="text-[#5a312a] whitespace-pre-line">
                        {item.content}
                      </p>
                      {item.extra}
                    </div>
